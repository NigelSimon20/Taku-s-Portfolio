            ...
            <div className="max-w-6xl mx-auto px-8">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-12 pb-12">
                    ...
                    <div className="flex flex-col gap-10">
                        ...
                        <div className="flex items-center gap-3 bg-[#141d2f] rounded-full px-6 py-3 w-fit">
                            ...
                            <a
                                href="#"
                                className="w-9 h-9 bg-[#1e6153] hover:bg-[#174d40] rounded-full flex items-center justify-center shrink-0 transition-colors"
                            >
                    ...
                    <div>
                        ...
                        <ul className="space-y-4">
                            ...
                            <li className="flex items-center gap-3 text-gray-300 text-sm">
                                <span className="w-7 h-7 bg-[#1e6153] rounded-md flex items-center justify-center shrink-0">
                ...
                <div className="flex items-center justify-between py-5">
                    ...
                    <button
                        ...
                        className="flex flex-col items-center gap-1 bg-white text-[#1e6153] rounded-t-2xl px-6 pt-3 pb-4 -mb-0 hover:bg-gray-100 transition-colors"
                    >
